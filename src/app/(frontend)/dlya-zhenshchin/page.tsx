...
export const metadata: Metadata = {
  ...
  description: 'Защита прав женщин при разводе. Алименты, раздел имущества, определение места жительства ребёнка. Адвокат Андреещев — 15+ лет опыта.',
  keywords: 'адвокат для женщин воронеж, развод женщин, защита прав матерей, алименты воронеж, раздел имущества, место жительства ребёнка, адвокат андреещев',
  alternates: { canonical: '/dlya-zhenshchin' },
  openGraph: {
    title: 'Адвокат для женщин при разводе в Воронеже — защита прав матерей',
    description: 'Защита прав женщин при разводе. Алименты, раздел имущества, определение места жительства ребёнка. Опыт 15+ лет.',
...
const defaultWhatIDo = [
  ...
  'Защищу от давления — выстрою стратегию, чтобы Вы не остались ни с чем',
  'Представлю Ваши интересы в суде — Вам не нужно видеться с ним лично',
]
...
export default async function FemaleLandingPage() {
  ...
  const s = settings?.femalePage as any
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 pt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                <div className="bg-white rounded-xl shadow-xl border border-gray-100 py-2 min-w-[220px]">
                  ...
                  <a href="/dlya-zhenshchin" className="block px-5 py-3 text-sm text-navy-900 font-semibold hover:bg-gold-50 transition-colors">Защита прав женщин</a>
      ...
      <header className="relative lg:min-h-[70vh] flex items-end lg:items-start overflow-hidden pt-20 lg:pt-[90px]" style={{ background: 'linear-gradient(165deg, #2A3A1E 0%, #3A4A2C 40%, #4D6340 100%)' }}>
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-xl text-gray-300 mb-[10px] font-light max-w-lg text-center lg:text-left lg:mb-10">Добьюсь справедливых алиментов, защищу имущество и обеспечу стабильность для Вас и детей.</p>
            <div className="flex justify-center lg:hidden" style={{ marginLeft: '-5px', marginTop: '-30px' }}>
              <img src="/images/photos/hero-female.webp" alt="Адвокат Андреещев" width={518} height={600} className="min-w-[130vw] h-auto shrink-0 object-contain object-bottom" style={{ mask: 'linear-gradient(to top, transparent 0%, black 3%, black 100%)', WebkitMask: 'linear-gradient(to top, transparent 0%, black 3%, black 100%)' }} />
            </div>
            <div className="flex flex-col sm:flex-row gap-4 pb-6">
              ...
              <FormModal title="Бесплатная консультация" buttonText="Записаться" page="female" className="hidden lg:block btn-gold rounded-xl px-8 py-4 text-navy-900 font-bold text-lg text-center transition-transform hover:scale-[0.98]">Бесплатная консультация</FormModal>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
            <div className="flex-shrink-0 w-full lg:w-auto flex justify-center">
              <img src="/images/photos/quote-female.webp" alt="Адвокат Андреещев" width={520} height={650} loading="lazy" className="w-[85vw] max-w-[520px] lg:w-[350px] h-auto rounded-2xl object-cover" />
            </div>
            <div>
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6 text-center lg:text-left">
                <strong className="text-white">За 15 лет практики я помог сотням женщин пройти через развод — спокойно, достойно и с результатом.</strong> Вам не нужно разбираться в законах и воевать с бывшим мужем. Я возьму это на себя — а Вы сможете наконец выдохнуть и сосредоточиться на себе и детях.
              </p>
          ...
          <div className="p-8 md:p-12 rounded-2xl border border-gray-200 bg-white">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div>
                ...
                <h2 className="font-serif text-3xl md:text-4xl font-bold text-navy-900 mb-6 text-center lg:text-left">Чем раньше Вы начнёте — тем сильнее Ваша позиция</h2>
                <ul className="space-y-3">
                  {['Узнаете, на что Вы имеете право — алименты, имущество, жильё', 'Поймёте, как защитить свои интересы и интересы детей', 'Получите пошаговый план действий на ближайшую неделю', 'Разберём Вашу ситуацию и наметим стратегию'].map((item, i) => (
              ...
              <FormModal title="Записаться на консультацию" buttonText="Отправить" page="female" className="btn-gold rounded-xl px-10 py-5 text-navy-900 font-bold text-lg text-center transition-transform hover:scale-[0.98] flex-shrink-0">Записаться на консультацию</FormModal>
            </div>
          </div>
        </div>
      </section>
