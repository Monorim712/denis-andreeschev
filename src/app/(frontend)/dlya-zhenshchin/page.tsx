        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex justify-center lg:hidden" style={{ marginLeft: '-5px', marginTop: '-30px' }}>
              <img src="/images/photos/hero-female.webp" alt="Адвокат Андреещев" className="min-w-[130vw] h-auto shrink-0 object-contain object-bottom" style={{ mask: 'linear-gradient(to top, transparent 0%, black 3%, black 100%)', WebkitMask: 'linear-gradient(to top, transparent 0%, black 3%, black 100%)' }} />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
            <div className="flex-shrink-0 w-full lg:w-auto flex justify-center">
              <img src="/images/photos/quote-female.webp" alt="Адвокат Андреещев" loading="lazy" className="w-[85vw] max-w-[520px] lg:w-[350px] h-auto rounded-2xl object-cover" />
            </div>
            <div>
