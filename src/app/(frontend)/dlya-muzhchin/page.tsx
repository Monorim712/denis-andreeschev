        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            ...
            <div className="flex justify-center lg:hidden -mb-5">
              <img src="/images/photos/hero-male.webp" alt="Адвокат Андреещев" className="h-[55vh] w-auto object-contain object-bottom" style={{ mask: 'linear-gradient(to top, transparent 0%, black 15%, black 90%, transparent 100%)', WebkitMask: 'linear-gradient(to top, transparent 0%, black 15%, black 90%, transparent 100%)' }} />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-shrink-0">
              <img src="/images/photos/quote-male.webp" alt="Адвокат Андреещев" className="w-full lg:w-[350px] h-auto rounded-2xl shadow-2xl object-cover" />
            </div>
            <div>
