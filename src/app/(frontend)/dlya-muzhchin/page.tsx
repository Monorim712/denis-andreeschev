...
export const metadata: Metadata = {
  ...
  description: 'Защита прав мужчин при разводе. Сохранение имущества, бизнеса, общение с детьми. Адвокат Андреещев — 10+ лет опыта в семейных делах.',
}
...
export default function MaleLandingPage() {
  return (
    <>
      ...
      <header className="relative min-h-screen flex items-center overflow-hidden pt-20" style={{ background: 'linear-gradient(165deg, #2A3A1E 0%, #3A4A2C 40%, #4D6340 100%)' }}>
        <div className="absolute right-0 bottom-0 w-1/2 h-full hidden lg:flex items-end justify-center z-[1]">
          <img src="/images/photos/hero-male.webp" alt="Адвокат Андреещев" className="h-[110vh] w-auto object-contain object-bottom" />
        </div>
        <div className="relative z-20 max-w-7xl mx-auto px-6 w-full">
          <div className="max-w-2xl">
            <span className="text-gold-400 font-medium tracking-[0.15em] mb-4 block uppercase text-xs">Защита прав мужчин при разводе</span>
            ...
            <p className="text-xl text-gray-300 mb-10 font-light max-w-lg">Сохраню ваше имущество, бизнес и право на общение с детьми. Без эмоций — только закон и стратегия.</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-shrink-0">
              <img src="/images/photos/quote-male.webp" alt="Адвокат Андреещев" className="w-[350px] h-auto rounded-2xl shadow-2xl object-cover" />
            </div>
            <div>
              <div className="w-[60px] h-[3px] bg-gold-400 mb-6" />
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-white mb-6">Вы не одиноки в этом</h2>
          ...
          <div className="p-8 md:p-12 rounded-2xl border border-gray-200 bg-white">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              <div>
                ...
                <h2 className="font-serif text-3xl md:text-4xl font-bold text-navy-900 mb-6">Каждый день промедления — в пользу другой стороны</h2>
